  ...
  function ionSlider($ionicModal,ionGalleryHelper,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function controller($scope){
      ...
      $scope.showImage = function(index) {
        ...
        /*$scope.slides[0] = $scope.ionGalleryItems[0];
        $scope.slides[1] = $scope.ionGalleryItems[0];
        $scope.slides[2] = $scope.ionGalleryItems[0];*/

        for(var i=0; i<galleryLength; i++) {
          $scope.slides[i] = $scope.ionGalleryItems[i];
        }
      ...
      $scope.slideChanged = function(currentSlideIndex) {
        /*alert(lastSlideIndex + "--" + currentSlideIndex);
